class Personne
  ...
  def subit_attaque(degats_recus)
    ...
    puts "#{nom} subit #{degats_recus}hp de dégats il lui reste #{points_de_vie}"
...
class Joueur < Personne
  ...
  def degats
    ...
    # - Calculer les dégats
    # - Affiche ce qu'il s'est passé
    puts "#{@nom} inflige 0hp de dégats bonus"
     degats = Random.rand(60) + @degats_bonus
  ...
  def soin
    ...
    # - Affiche ce qu'il s'est passé
     if @points_de_vie < 100
      @points_de_vie = @points_de_vie + Random.rand(50)
      puts "#{@nom} regagne de la vie"
     else
      puts "#{@nom} est déja au maximum !"
     end
  ...
  def ameliorer_degats
    ...
    # - Affiche ce qu'il s'est passé
    @degats_bonus = @degats_bonus + Random.rand(60)
    puts "#{@nom} augmente sa force de #{@degats_bonus}"
  end
end
  ...
  def ennemis_en_vie
    ...
    survivant = []
       ...
       @ennemis.each do |ennemi|
         survivant << ennemi if ennemi.en_vie
       end
